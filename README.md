...
| BFLYT | Layout | 🟡 | 🟡 | Wii U layout; does NOT share BCLYT's struct layout (correction — see below); pan1/lyt1/grp1/mat1/prt1/txt1/cnt1 fixed for real Wii U files (2026-08-19: cnt1 name-offset + anim-table offsets corrected against real Splatoon samples, 205/251 -> 218/251 on the Splatoon corpus, 0 regressions); decode only — encoders still 3DS-shaped; remaining Splatoon-corpus failures trace to mat1, not cnt1 |
