...
| GTX / GSH | Texture / shader | 🟡 | 🟡 | Wii U GX2 "Gfx2" container; lossless bounds-checked block parsing for GTX and shader-only GSH, shader relocation/string-table metadata, vertex/pixel/geometry/compute header↔program associations, and unknown blocks retained. `wszst EXTRACT file.gsh` emits named, losslessly reassemblable Latte control-flow listings. Texture APIs cover explicit mips, array/cube/3D slices, MSAA samples, depth/stencil visualization, component selectors, tile modes 0-15, thick tiles, bank swaps, and pipe/bank/slice/sample rotation. RGBA8/R10G10B10A2/R8/R4G4/R8G8/565/5551/4444 + BC1-5 decode is supported; RGBA8 encode uses genuine 2D macro tiling. Full ALU/TEX/VTX operand pretty-printing and high-level GLSL compilation remain delegated to Latte Assembler/CafeGLSL rather than misrepresented as a container feature. |
