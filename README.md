...
| **NUMSHB** | `.numshb` | **GLB** | ✅ | — | — | ✅ | Bandai Namco SSBH 3D mesh model (*Super Smash Bros. Ultimate* Switch). MESH v1.10: positions, normals, UVs, and skinning when the sibling `.nusktb` skeleton is present. v1.8 lays its object record out differently and is declined; tangents and colour sets are parsed but not exported |
