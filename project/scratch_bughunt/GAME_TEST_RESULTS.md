...
|---|---|---|---|---|
| And-Kensaku | 🟡 | 2716 / 53790 | TPL:1624, BRFNT:934, LZ11:158 | `ERROR_EXIT28` (32 errors logged) — re-tested against the AnmTexPat fix. |
...
| GoldenEye 007 (2010 video game) | 🟡 | 56 / 47068 | TPL:54, BRFNT:2 | `ERROR_EXIT28` (27 errors logged). |
...
| Inazuma Eleven Strikers | 🟡 | 29 / 51113 | LZH8:18, BRFNT:11 | `ERROR_EXIT28` (126 errors logged). |
...
| Mario & Sonic at the London 2012 Olympic Games | 🟡 | 52 / 54470 | LZH8:48, BRFNT:4 | `ERROR_EXIT28` (32 errors logged) — re-tested against the AnmTexPat fix. |
