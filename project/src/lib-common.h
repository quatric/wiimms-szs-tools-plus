...
{
	file_format_t fform; // FF_UNKNOWN or known file format
...
{
	DASSERT (ot);
	return ot->new_object == NEWOBJ_OFF && ot->object_slots == OBJMGR_USUAL_SLOTS
...
enumError ScanRawITEMSLOT (itemslot_t *itemslot, // ITEMSLOT data structure
...
enumError ScanTextITEMSLOT (itemslot_t *itemslot, // ITEMSLOT data structure
	bool init_itemslot, // true: initialize 'itemslot' first
	const void *data, // data to scan
	uint data_size, // size of 'data'
...
enumError ScanITEMSLOT (itemslot_t *itemslot, // ITEMSLOT data structure
	bool init_itemslot, // true: initialize 'itemslot' first
	const void *data, // data to scan
	uint data_size, // size of 'data'
...
enumError LoadITEMSLOT (itemslot_t *itemslot, // ITEMSLOT data structure
	bool init_itemslot, // true: initialize 'itemslot' first
...
enumError SaveRawITEMSLOT (itemslot_t *itemslot, // pointer to valid ITEMSLOT
...
enumError SaveTextITEMSLOT (const itemslot_t *itemslot, // pointer to valid ITEMSLOT
	ccp fname, // filename of destination
	bool set_time, // true: set time stamps
...
{
	/*000*/ minigame_kmg_head_t head; // file header
...
enumError ScanRawOBJFLOW (objflow_t *objflow, // OBJFLOW data structure
...
enumError ScanTextOBJFLOW (objflow_t *objflow, // OBJFLOW data structure
	bool init_objflow, // true: initialize 'objflow' first
	const void *data, // data to scan
	uint data_size // size of 'data'
);
...
enumError ScanOBJFLOW (objflow_t *objflow, // OBJFLOW data structure
	bool init_objflow, // true: initialize 'objflow' first
	const void *data, // data to scan
	uint data_size // size of 'data'
);
...
enumError LoadOBJFLOW (objflow_t *objflow, // OBJFLOW data structure
	bool init_objflow, // true: initialize 'objflow' first
	ccp fname, // valid pointer to filenname
	bool ignore_no_file // ignore if file does not exists
						// and return warning ERR_NOT_EXISTS
...
enumError SaveRawOBJFLOW (objflow_t *objflow, // pointer to valid OBJFLOW
	ccp fname, // filename of destination
	bool set_time // true: set time stamps
);
...
enumError SaveTextOBJFLOW (const objflow_t *objflow, // pointer to valid OBJFLOW
	ccp fname, // filename of destination
	bool set_time, // true: set time stamps
	int minimize // usually a copy of global 'minimize_level':
				 //   >0: write only modified sections
...
enumError ScanRawGEOHIT (geohit_t *geohit, // GEOHIT data structure
...
enumError ScanTextGEOHIT (geohit_t *geohit, // GEOHIT data structure
	bool init_geohit, // true: initialize 'geohit' first
	const void *data, // data to scan
	uint data_size, // size of 'data'
	file_format_t fform // file format
...
enumError ScanGEOHIT (geohit_t *geohit, // GEOHIT data structure
	bool init_geohit, // true: initialize 'geohit' first
	const void *data, // data to scan
	uint data_size // size of 'data'
);
...
enumError LoadGEOHIT (geohit_t *geohit, // GEOHIT data structure
	bool init_geohit, // true: initialize 'geohit' first
	ccp fname, // valid pointer to filenname
	bool ignore_no_file // ignore if file does not exists
						// and return warning ERR_NOT_EXISTS
...
enumError SaveRawGEOHIT (geohit_t *geohit, // pointer to valid GEOHIT
	ccp fname, // filename of destination
	bool set_time // true: set time stamps
);
...
enumError SaveTextGEOHIT (const geohit_t *geohit, // pointer to valid GEOHIT
	ccp fname, // filename of destination
	bool set_time, // true: set time stamps
	int minimize // usually a copy of global 'minimize_level':
				 //   >0: write only modified sections
