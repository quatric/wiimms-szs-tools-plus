...
static const u32 pal_track_offset[] = { 0x37fcd0, 0x384f58, 0x397da8, 0x398130, 0x39d040, 0 };

static const u32 pal_arena_offset[] = { 0x384fd8, 0x3974f8, 0x397780, 0x39c8e0, 0 };

//-----------------------------------------------------------------------------

static const u32 usa_track_offset[] = { 0x37fbe0, 0x3839e0, 0x397450, 0x3977d8, 0x39b300, 0 };

static const u32 usa_arena_offset[] = { 0x383a60, 0x39d130, 0x39d3b8, 0x39e988, 0 };

//-----------------------------------------------------------------------------

static const u32 jap_track_offset[] = { 0x37f9a0, 0x384c28, 0x397588, 0x397910, 0x39c820, 0 };

static const u32 jap_arena_offset[] = { 0x384ca8, 0x396cd8, 0x396f60, 0x39c0c0, 0 };

//-----------------------------------------------------------------------------

static const u32 kor_track_offset[] = { 0x3800b0, 0x385348, 0x3981e8, 0x398570, 0x39d480, 0 };

static const u32 kor_arena_offset[] = { 0x3853c8, 0x397938, 0x397bc0, 0x39cd20, 0 };
...
static const region_patch_t vs_region_patch[]
	= { { 0, { 0x143364, 0x14325c, 0x143050, 0x14365c }, 0x80a30084, 0x38a00000,
			"vs: locstring status" },
		  { 1, { 0x149d54, 0x149c4c, 0x149a40, 0x14a04c }, 0x80840084, 0x38800000,
			  "vs: check locstring, masked by 0xff" },
		  { 0, { 0x148f2c, 0x148e24, 0x148c18, 0x149224 }, 0x80e50084, 0x38e00000,
			  "'vs_#' at regional matches." },
		  { 0, { 0x149444, 0x14933c, 0x149130, 0x14973c }, 0x80e50084, 0x38e00000,
			  "'vs_#' after friend connect" },
		  { 0, { 0, 0, 0, 0 }, 0, 0, 0 } };

static const region_patch_t bt_region_patch[]
	= { { 0, { 0x1433d0, 0x1432c8, 0x1430bc, 0x1436c8 }, 0x80c30084, 0x38c00000,
			"bt: locstring status" },
		  { 1, { 0x149da0, 0x149c98, 0x149a8c, 0x14a098 }, 0x80840084, 0x38800000,
			  "bt: check locstring, masked by 0xff" },
		  { 0, { 0x148f80, 0x148e78, 0x148c6c, 0x149278 }, 0x80e50084, 0x38e00000,
			  "'bt_#' at regional matches." },
		  { 0, { 0x149498, 0x149390, 0x149184, 0x149790 }, 0x80e50084, 0x38e00000,
			  "'bt_#' after friend connect" },
		  { 0, { 0, 0, 0, 0 }, 0, 0, 0 } };

enum
{
	N_TAB_VS_REGION_PATCH = sizeof (vs_region_patch) / sizeof (*vs_region_patch) - 1,
	N_VS_REGION_PATCH = N_TAB_VS_REGION_PATCH < MAX_REGION_PATCH ? N_TAB_VS_REGION_PATCH
																 : MAX_REGION_PATCH,

	N_TAB_BT_REGION_PATCH = sizeof (bt_region_patch) / sizeof (*bt_region_patch) - 1,
	N_BT_REGION_PATCH = N_TAB_BT_REGION_PATCH < MAX_REGION_PATCH ? N_TAB_BT_REGION_PATCH
																 : MAX_REGION_PATCH,
};
...
typedef struct region_info_t
{
	...
	const region_patch_t *patch_tab; // patch table
...
static const u32 pal_all_ranks_offset[] = { 0x389f36, 0x389f52, 0 };

static const u32 usa_all_ranks_offset[] = { 0x389be6, 0x389c02, 0 };

static const u32 jap_all_ranks_offset[] = { 0x389716, 0x389732, 0 };

static const u32 kor_all_ranks_offset[] = { 0x38a34e, 0x38a36a, 0 };
...
static const u32 pal_vs_offset[] = { 0x389f1b, 0x389f24, 0x389f9e, 0x389fa7, 0 };

static const u32 usa_vs_offset[] = { 0x389bcb, 0x389bd4, 0x389c4e, 0x389c57, 0 };

static const u32 jap_vs_offset[] = { 0x3896fb, 0x389704, 0x38977e, 0x389787, 0 };

static const u32 kor_vs_offset[] = { 0x38a333, 0x38a33c, 0x38a3b6, 0x38a3bf, 0 };

//-----------------------------------------------------------------------------

static const u32 pal_bt_offset[] = { 0x389f2a, 0x389f33, 0x389fad, 0x389fb6, 0 };

static const u32 usa_bt_offset[] = { 0x389bda, 0x389be3, 0x389c5d, 0x389c66, 0 };

static const u32 jap_bt_offset[] = { 0x38970a, 0x389713, 0x38978d, 0x389796, 0 };

static const u32 kor_bt_offset[] = { 0x38a342, 0x38a34b, 0x38a3c5, 0x38a3ce, 0 };
...
static const u32 pal_menu_offset[] = { 0x387b64, // /Scene/UI/MenuSingle
...
static const u32 usa_menu_offset[] = { 0x38513c, // /Scene/UI/MenuSingle
...
static const u32 jap_menu_offset[] = { 0x387834, // /Scene/UI/MenuSingle
...
static const u32 kor_menu_offset[] = { 0x38846c, // /Scene/UI/MenuSingle
...
static const int meno_patch_idx[] = { 1, // Single: Global VS + Battle
	2, // Single: Room
...
const str_server_list_t ServerList[SERV__N + 1]
	= { { SERV_NONE, "NONE", 0, 0, "" }, { SERV_NASW, "NASW", 90, 23, "naswii.nintendowifi.net" },
		  ...
		  { SERV_GS, "GS", 0, 19, "gs.nintendowifi.net" }, { 0, 0, 0, 0, 0 } };

///////////////////////////////////////////////////////////////////////////////

const str_server_patch_t ServerPatch[217 + 1] = { { STR_M_PAL, 0, 2, SERV_NONE, 0x38aa32, 5, "" },
	...
	{ STR_M_PAL, 1, 0, SERV_GS, 0x2718be, 19, "" }, { STR_M_PAL, 1, 0, SERV_GS, 0x272635, 19, "" },
	{ STR_M_PAL, 1, 0, SERV_GS, 0x272651, 19, "" }, { STR_M_PAL, 1, 0, SERV_GS, 0x272672, 19, "" },
	{ STR_M_PAL, 1, 0, SERV_GS, 0x272693, 19, "" }, { STR_M_PAL, 1, 0, SERV_GS, 0x2726b5, 19, "" },
	{ STR_M_PAL, 1, 0, SERV_GS, 0x2726d7, 19, "" }, { STR_M_PAL, 1, 0, SERV_GS, 0x2726f7, 19, "" },
	{ STR_M_PAL, 1, 0, SERV_GS, 0x272717, 19, "" }, { STR_M_PAL, 1, 0, SERV_GS, 0x272736, 19, "" },
	{ STR_M_PAL, 1, 0, SERV_GS, 0x272759, 19, "" }, { STR_M_PAL, 1, 0, SERV_GS, 0x27277e, 19, "" },
	{ STR_M_PAL, 1, 0, SERV_GS, 0x27279c, 19, "" }, { STR_M_PAL, 1, 0, SERV_GS, 0x276e65, 19, "" },
	{ STR_M_PAL, 1, 0, SERV_GS, 0x2775d5, 19, "" }, { STR_M_PAL, 1, 0, SERV_GS, 0x277fed, 19, "" },
	{ STR_M_PAL, 1, 0, SERV_GS, 0x27918e, 19, "" }, { STR_M_PAL, 1, 0, SERV_GS, 0x279b82, 19, "" },
	{ STR_M_PAL, 1, 0, SERV_GS, 0x279da8, 19, "" }, { STR_M_PAL, 1, 0, SERV_GS, 0x279dc4, 19, "" },
	{ STR_M_PAL, 1, 0, SERV_GS, 0x279de0, 19, "" }, { STR_M_PAL, 1, 0, SERV_GS, 0x279f30, 19, "" },
	...
	{ STR_M_USA, 0, 2, SERV_SAKE, 0x389d60, 100,
		"/SakeFileServer/ghostdownload.aspx?gameid=1687&region=0" },
	{ STR_M_USA, 0, 0, SERV_GS, 0x38a344, 117,
		"/SakeFileServer/"
		"ghostupload.aspx?gameid=%d&regionid=%d&courseid=%d&score=%d&pid=%d&playerinfo=%s%s" },
	{ STR_M_USA, 0, 0, SERV_GS, 0x38a477, 92,
		"/SakeFileServer/ghostdownload.aspx?gameid=1687&region=0&p0=%d&c0=%d&t0=%d" },
	...
	{ STR_M_USA, 1, 0, SERV_GS, 0x26d55e, 19, "" }, { STR_M_USA, 1, 0, SERV_GS, 0x26e2d5, 19, "" },
	{ STR_M_USA, 1, 0, SERV_GS, 0x26e2f1, 19, "" }, { STR_M_USA, 1, 0, SERV_GS, 0x26e312, 19, "" },
	{ STR_M_USA, 1, 0, SERV_GS, 0x26e333, 19, "" }, { STR_M_USA, 1, 0, SERV_GS, 0x26e355, 19, "" },
	{ STR_M_USA, 1, 0, SERV_GS, 0x26e377, 19, "" }, { STR_M_USA, 1, 0, SERV_GS, 0x26e397, 19, "" },
	{ STR_M_USA, 1, 0, SERV_GS, 0x26e3b7, 19, "" }, { STR_M_USA, 1, 0, SERV_GS, 0x26e3d6, 19, "" },
	{ STR_M_USA, 1, 0, SERV_GS, 0x26e3f9, 19, "" }, { STR_M_USA, 1, 0, SERV_GS, 0x26e41e, 19, "" },
	{ STR_M_USA, 1, 0, SERV_GS, 0x26e43c, 19, "" }, { STR_M_USA, 1, 0, SERV_GS, 0x272b05, 19, "" },
	{ STR_M_USA, 1, 0, SERV_GS, 0x273275, 19, "" }, { STR_M_USA, 1, 0, SERV_GS, 0x273c8d, 19, "" },
	{ STR_M_USA, 1, 0, SERV_GS, 0x274e2e, 19, "" }, { STR_M_USA, 1, 0, SERV_GS, 0x275822, 19, "" },
	{ STR_M_USA, 1, 0, SERV_GS, 0x275a48, 19, "" }, { STR_M_USA, 1, 0, SERV_GS, 0x275a64, 19, "" },
	{ STR_M_USA, 1, 0, SERV_GS, 0x275a80, 19, "" }, { STR_M_USA, 1, 0, SERV_GS, 0x275bd0, 19, "" },
	...
	{ STR_M_JAP, 0, 2, SERV_SAKE, 0x389bb8, 100,
		"/SakeFileServer/ghostdownload.aspx?gameid=1687&region=0" },
	{ STR_M_JAP, 0, 0, SERV_GS, 0x38a19c, 117,
		"/SakeFileServer/"
		"ghostupload.aspx?gameid=%d&regionid=%d&courseid=%d&score=%d&pid=%d&playerinfo=%s%s" },
	{ STR_M_JAP, 0, 0, SERV_GS, 0x38a2cf, 92,
		"/SakeFileServer/ghostdownload.aspx?gameid=1687&region=0&p0=%d&c0=%d&t0=%d" },
	...
	{ STR_M_JAP, 1, 0, SERV_GS, 0x27123e, 19, "" }, { STR_M_JAP, 1, 0, SERV_GS, 0x271fb5, 19, "" },
	{ STR_M_JAP, 1, 0, SERV_GS, 0x271fd1, 19, "" }, { STR_M_JAP, 1, 0, SERV_GS, 0x271ff2, 19, "" },
	{ STR_M_JAP, 1, 0, SERV_GS, 0x272013, 19, "" }, { STR_M_JAP, 1, 0, SERV_GS, 0x272035, 19, "" },
	{ STR_M_JAP, 1, 0, SERV_GS, 0x272057, 19, "" }, { STR_M_JAP, 1, 0, SERV_GS, 0x272077, 19, "" },
	{ STR_M_JAP, 1, 0, SERV_GS, 0x272097, 19, "" }, { STR_M_JAP, 1, 0, SERV_GS, 0x2720b6, 19, "" },
	{ STR_M_JAP, 1, 0, SERV_GS, 0x2720d9, 19, "" }, { STR_M_JAP, 1, 0, SERV_GS, 0x2720fe, 19, "" },
	{ STR_M_JAP, 1, 0, SERV_GS, 0x27211c, 19, "" }, { STR_M_JAP, 1, 0, SERV_GS, 0x2767e5, 19, "" },
	{ STR_M_JAP, 1, 0, SERV_GS, 0x276f55, 19, "" }, { STR_M_JAP, 1, 0, SERV_GS, 0x27796d, 19, "" },
	{ STR_M_JAP, 1, 0, SERV_GS, 0x278b0e, 19, "" }, { STR_M_JAP, 1, 0, SERV_GS, 0x279502, 19, "" },
	{ STR_M_JAP, 1, 0, SERV_GS, 0x279728, 19, "" }, { STR_M_JAP, 1, 0, SERV_GS, 0x279744, 19, "" },
	{ STR_M_JAP, 1, 0, SERV_GS, 0x279760, 19, "" }, { STR_M_JAP, 1, 0, SERV_GS, 0x2798b0, 19, "" },
	...
	{ STR_M_KOR, 0, 2, SERV_MKW_RACE, 0x38ad65, 89,
		"/RaceServiceStage/NintendoRacingService.asmx" },
	{ STR_M_KOR, 0, 2, SERV_SAKE, 0x38a7f0, 100,
		"/SakeFileServer/ghostdownload.aspx?gameid=1687&region=0" },
	{ STR_M_KOR, 0, 2, SERV_SAKE, 0x38adcb, 131,
		"/%s/ghostupload.aspx?gameid=%d&regionid=%d&courseid=%d&score=%d&pid=%d&playerinfo=%s%s" },
	{ STR_M_KOR, 0, 2, SERV_SAKE, 0x38af0b, 106,
		"/%s/ghostdownload.aspx?gameid=1687&region=0&p0=%d&c0=%d&t0=%d" },
	...
	{ STR_M_KOR, 1, 0, SERV_GS, 0x25f69e, 19, "" }, { STR_M_KOR, 1, 0, SERV_GS, 0x260415, 19, "" },
	{ STR_M_KOR, 1, 0, SERV_GS, 0x260431, 19, "" }, { STR_M_KOR, 1, 0, SERV_GS, 0x260452, 19, "" },
	{ STR_M_KOR, 1, 0, SERV_GS, 0x260473, 19, "" }, { STR_M_KOR, 1, 0, SERV_GS, 0x260495, 19, "" },
	{ STR_M_KOR, 1, 0, SERV_GS, 0x2604b7, 19, "" }, { STR_M_KOR, 1, 0, SERV_GS, 0x2604d7, 19, "" },
	{ STR_M_KOR, 1, 0, SERV_GS, 0x2604f7, 19, "" }, { STR_M_KOR, 1, 0, SERV_GS, 0x260516, 19, "" },
	{ STR_M_KOR, 1, 0, SERV_GS, 0x260539, 19, "" }, { STR_M_KOR, 1, 0, SERV_GS, 0x26055e, 19, "" },
	{ STR_M_KOR, 1, 0, SERV_GS, 0x26057c, 19, "" }, { STR_M_KOR, 1, 0, SERV_GS, 0x264d15, 19, "" },
	{ STR_M_KOR, 1, 0, SERV_GS, 0x265485, 19, "" }, { STR_M_KOR, 1, 0, SERV_GS, 0x265e9d, 19, "" },
	{ STR_M_KOR, 1, 0, SERV_GS, 0x26703e, 19, "" }, { STR_M_KOR, 1, 0, SERV_GS, 0x267a32, 19, "" },
	{ STR_M_KOR, 1, 0, SERV_GS, 0x267c58, 19, "" }, { STR_M_KOR, 1, 0, SERV_GS, 0x267c74, 19, "" },
	{ STR_M_KOR, 1, 0, SERV_GS, 0x267c90, 19, "" }, { STR_M_KOR, 1, 0, SERV_GS, 0x267de0, 19, "" },
	...
	if (version->timestamp < BINTIME || version->revision < REVISION_NUM)
	{
		if (!silent || verbose > 0)
			ERROR0 (ERR_WARNING, "Porting DB is outdated and ignored: %s (%s, rev %u)\n", path,
				PrintTimeByFormat ("%F", version->timestamp), version->revision);
		goto abort;
	}
...
const u32 *GetTrackOffsetTab (str_mode_t mode)
{
	...
	{
		case STR_M_PAL:
			return pal_track_offset;
		case STR_M_USA:
			return usa_track_offset;
		case STR_M_JAP:
			return jap_track_offset;
		case STR_M_KOR:
			return kor_track_offset;
		default:
			return 0;
	}
}
...
const u32 *GetArenaOffsetTab (str_mode_t mode)
{
	...
	{
		case STR_M_PAL:
			return pal_arena_offset;
		case STR_M_USA:
			return usa_arena_offset;
		case STR_M_JAP:
			return jap_arena_offset;
		case STR_M_KOR:
			return kor_arena_offset;
		default:
			return 0;
	}
}
...
const u32 *GetAllRanksOffsetTab (const staticr_t *str)
{
	if (str)
	{
		...
		{
			case STR_M_PAL:
				return pal_all_ranks_offset;
			case STR_M_USA:
				return usa_all_ranks_offset;
			case STR_M_JAP:
				return jap_all_ranks_offset;
			case STR_M_KOR:
				return kor_all_ranks_offset;
			default:
				return 0;
		}
	}
...
const u32 *GetVsBtOffsetTab (const staticr_t *str, bool battle)
{
	if (str)
	{
		if (battle)
		{
			...
			{
				case STR_M_PAL:
					return pal_bt_offset;
				case STR_M_USA:
					return usa_bt_offset;
				case STR_M_JAP:
					return jap_bt_offset;
				case STR_M_KOR:
					return kor_bt_offset;
				default:
					return 0;
			}
		}
		else
		{
			...
			{
				case STR_M_PAL:
					return pal_vs_offset;
				case STR_M_USA:
					return usa_vs_offset;
				case STR_M_JAP:
					return jap_vs_offset;
				case STR_M_KOR:
					return kor_vs_offset;
				default:
					return 0;
			}
		}
...
const u32 *GetMenuOffsetTab (str_mode_t mode)
{
	...
	{
		case STR_M_PAL:
			return pal_menu_offset;
		case STR_M_USA:
			return usa_menu_offset;
		case STR_M_JAP:
			return jap_menu_offset;
		case STR_M_KOR:
			return kor_menu_offset;
		default:
			return 0;
	}
}
...
static u32 GetVbiAddress (const staticr_t *str)
{
	...
	switch (str->mode)
	{
		...
		case STR_M_KOR:
			return 0x801bae7c;
		default:
			return FindDolAddressOfVBI (str->data, str->data_size);
	}
}
...
static BZ2Manager_t *GetWiimmfiCode (str_mode_t mode)
{
	...
	{
		case STR_M_PAL:
			return &wiimmfi_code_pal_mgr;
		case STR_M_USA:
			return &wiimmfi_code_usa_mgr;
		case STR_M_JAP:
			return &wiimmfi_code_jap_mgr;
		case STR_M_KOR:
			return &wiimmfi_code_kor_mgr;
		default:
			return 0;
	}
}
...
static const u8 old_lecode_loader_jap_lzma[] = // old_lecode_loader_jap.bin
	{
		// decompressed size: 0x200 = 512 bytes
		0x00,
		0x00,
		0x02,
		0x00,
		...
		0xa8,
		0xf6,
		// 0x1ae = 430 data bytes (85%)
	};

static CompressManager_t old_lecode_loader_jap_mgr
	= { FF_LZMA, old_lecode_loader_jap_lzma, sizeof (old_lecode_loader_jap_lzma), 0, 0 };

//-----------------------------------------------------------------------------------

static const u8 old_lecode_loader_kor_lzma[] = // old_lecode_loader_kor.bin
	{
		// decompressed size: 0x200 = 512 bytes
		0x00,
		0x00,
...
static CompressManager_t old_lecode_loader_kor_mgr
	= { FF_LZMA, old_lecode_loader_kor_lzma, sizeof (old_lecode_loader_kor_lzma), 0, 0 };

//-----------------------------------------------------------------------------------

static const u8 old_lecode_loader_pal_lzma[] = // old_lecode_loader_pal.bin
	{
		// decompressed size: 0x200 = 512 bytes
		0x00,
		0x00,
...
static CompressManager_t old_lecode_loader_pal_mgr
	= { FF_LZMA, old_lecode_loader_pal_lzma, sizeof (old_lecode_loader_pal_lzma), 0, 0 };

//-----------------------------------------------------------------------------------

static const u8 old_lecode_loader_usa_lzma[] = // old_lecode_loader_usa.bin
	{
		// decompressed size: 0x200 = 512 bytes
		0x00,
		0x00,
...
static CompressManager_t old_lecode_loader_usa_mgr
	= { FF_LZMA, old_lecode_loader_usa_lzma, sizeof (old_lecode_loader_usa_lzma), 0, 0 };

//-----------------------------------------------------------------------------

static CompressManager_t *GetOldLecodeLoader (str_mode_t mode)
{
	switch (mode)
	{
		case STR_M_PAL:
			return &old_lecode_loader_pal_mgr;
		case STR_M_USA:
			return &old_lecode_loader_usa_mgr;
		case STR_M_JAP:
			return &old_lecode_loader_jap_mgr;
		case STR_M_KOR:
			return &old_lecode_loader_kor_mgr;
		default:
			return 0;
	}
}
...
static const u8 lecode_loader_jap_lzma[] = // lecode-loader-jap.bin
	{
...
static CompressManager_t lecode_loader_jap_mgr
	= { FF_LZMA, lecode_loader_jap_lzma, sizeof (lecode_loader_jap_lzma), 0, 0 };

//-----------------------------------------------------------------------------------

static const u8 lecode_loader_kor_lzma[] = // lecode-loader-kor.bin
	{
		// decompressed size: 0x210 = 528 bytes
		0x00,
		0x00,
...
static CompressManager_t lecode_loader_kor_mgr
	= { FF_LZMA, lecode_loader_kor_lzma, sizeof (lecode_loader_kor_lzma), 0, 0 };
...
static CompressManager_t lecode_loader_pal_mgr
	= { FF_LZMA, lecode_loader_pal_lzma, sizeof (lecode_loader_pal_lzma), 0, 0 };

//-----------------------------------------------------------------------------------

static const u8 lecode_loader_usa_lzma[] = // lecode-loader-usa.bin
	{
		// decompressed size: 0x210 = 528 bytes
		0x00,
		0x00,
...
static CompressManager_t lecode_loader_usa_mgr
	= { FF_LZMA, lecode_loader_usa_lzma, sizeof (lecode_loader_usa_lzma), 0, 0 };

//-----------------------------------------------------------------------------

static CompressManager_t *GetLecodeLoader (str_mode_t mode)
{
	switch (mode)
	{
		case STR_M_PAL:
			return &lecode_loader_pal_mgr;
		case STR_M_USA:
			return &lecode_loader_usa_mgr;
		case STR_M_JAP:
			return &lecode_loader_jap_mgr;
		case STR_M_KOR:
			return &lecode_loader_kor_mgr;
		default:
			return 0;
	}
}
...
static BZ2Manager_t codehandler_mgr = { codehandler_bz2, sizeof (codehandler_bz2), 0, 0 };
...
static rel_info_t rel_info_pal = { 0xd4, // offset_sect
	0x3cd104, // fix_size
	0x78b0, // bss_size
...
static rel_info_t rel_info_usa = { 0xd4, // offset_sect
	0x3ccd2c, // fix_size
	0x78b0, // bss_size
...
static rel_info_t rel_info_jap = { 0xd4, // offset_sect
	0x3cc8d4, // fix_size
	0x78b0, // bss_size
...
static rel_info_t rel_info_kor = { 0xd4, // offset_sect
	0x3cd57c, // fix_size
	0x78b0, // bss_size
