...
typedef enum mdl_mode_t
{
	...
	MDLMD_M_NODES = MDLMD_PARENT_NODE | MDLMD_CHILD_NODES,
	...
	MDLMD_M_ALL = MDLMD_M_OBJECT // all relevant bits
		| MDLMD_M_PATCH | MDLMD_M_HIDDEN | MDLMD_M_TEST,
...
ccp GetStringExMDL (mdl_t *mdl, // MDL data structure
	const void *base, // base for offset
...
typedef enumError (*iterate_mdl_func) (mdl_t *mdl, // MDL data structure
...
void ImportMatrixMDLs1 (mdl_sect1_t *ms, // valid and initialized data
...
void ExportMatrixMDLs1 (mdl_sect1_t *ms, // valid and initialized data
	bool network_order, // true: data is in network byte order
...
typedef void (*SectionFuncMDL) (struct StringIteratorMDL_t *sit, // string iterator data
	MemItem_t *mi // memory item of section
);

//-----------------------------------------------------------------------------

typedef void (*OffsetFuncMDL) (struct StringIteratorMDL_t *sit, // string iterator data
...
typedef void (*StringFuncMDL) (struct StringIteratorMDL_t *sit, // string iterator data
