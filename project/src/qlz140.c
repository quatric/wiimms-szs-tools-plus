...
#define qlz_get_setting qlz140_get_setting
#define qlz_size_compressed qlz140_size_compressed
#define qlz_size_decompressed qlz140_size_decompressed

#include "wqlz_comp_140.c"
