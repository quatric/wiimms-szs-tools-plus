...
//-----------------------------------------------------------------------------
// SZE (Encrypted SZS / SARC / Zstd container used by F-Zero 99 and Switch
// titles). Recovered from the pre-split lib-nintendo.c implementation
// (commit 1433fb8), which the archive-modularization refactor dropped
// along with its declaration; logic unchanged.
//-----------------------------------------------------------------------------
