...
void SetupFeaturesSZS (features_szs_t *fs, const struct szs_have_t *have, bool is_lex);
...
void SetupCheckFeaturesSZS (check_features_szs_t *cfs, const struct szs_have_t *have, bool is_lex);
...
struct szs_norm_t;
void AddSectionsLEX (
	struct szs_file_t *szs, struct szs_norm_t *norm, const struct szs_have_t *have);
