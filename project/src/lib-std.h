...
typedef int (*SubFileFunc) (struct SubFileIterator_t *sfi, // iterator data
...
DataContainer_t *NewContainer (DataContainer_t *dc, // old_container to reuse, if
													// InDataContainer(dc,data) && ref:count == 1
...
static inline bool IsRepairMagic ()
{
	return repair_magic > REPMD_OFF;
}
...
typedef enum patch_file_t
{
	...
	PFILE_M_NONE = PFILE_UNKNOWN | PFILE_NO_FILENAME,

	PFILE_M_KCL = PFILE_COURSE_KCL | PFILE_OTHER_KCL,

	PFILE_M_BRRES = PFILE_MODEL | PFILE_MINIMAP | PFILE_VRCORN | PFILE_OTHER_BRRES,

	PFILE_M_TRACK = PFILE_COURSE_KMP // mask for 'TRACK' keyword
		| PFILE_COURSE_KCL | PFILE_MODEL | PFILE_MINIMAP | PFILE_VRCORN,

	PFILE_M_ALL = PFILE_M_NONE | PFILE_COURSE | PFILE_COURSE_KMP | PFILE_M_KCL | PFILE_M_BRRES
		| PFILE_F_LOG | PFILE_F_LOG_ALL,
	// not PFILE_F_HIDE

	PFILE_M_SILENT = PFILE_M_TRACK,

	PFILE_M_DEFAULT = PFILE_M_SILENT | PFILE_F_LOG,
...
typedef enum SlotMode_t
{
	...
	SLOTMD_JOB_RM_SZS = SLOTMD_RM_ICE | SLOTMD_RM_SUNDS | SLOTMD_RM_SHYGUY,

	SLOTMD_JOB_ADD_SZS = SLOTMD_ADD_BICE | SLOTMD_ADD_SHYGUY,

	SLOTMD_JOB_KCL = SLOTMD_ICE_TO_WATER | SLOTMD_WATER_TO_ICE,

	SLOTMD_JOB_KMP = SLOTMD_RM_ICE | SLOTMD_RM_SUNDS | SLOTMD_RM_SHYGUY | SLOTMD_ADD_GICE
		| SLOTMD_ADD_SHYGUY,

	//--- mode for --slot

	SLOTMD_M_DAISY = SLOTMD_RM_ICE | SLOTMD_RM_SHYGUY | SLOTMD_ICE_TO_WATER,

	SLOTMD_M_SHERBET = SLOTMD_RM_SUNDS | SLOTMD_RM_SHYGUY | SLOTMD_ADD_GICE | SLOTMD_ADD_BICE
		| SLOTMD_WATER_TO_ICE,

	SLOTMD_M_SHYGUY = SLOTMD_RM_ICE | SLOTMD_RM_SUNDS | SLOTMD_ADD_SHYGUY | SLOTMD_ICE_TO_WATER,

	SLOTMD_M_STANDARD = SLOTMD_RM_ICE | SLOTMD_RM_SUNDS | SLOTMD_RM_SHYGUY | SLOTMD_ICE_TO_WATER,

	SLOTMD_M_MOST = SLOTMD_RM_SUNDS | SLOTMD_RM_SHYGUY | SLOTMD_ADD_BICE | SLOTMD_ICE_TO_WATER,
} SlotMode_t;
...
typedef int (*IterateTrackFilesFunc) (ccp fname, // name of current file without '.szs' extension
...
valid_t IsValidKCL (struct kcl_analyze_t *ka, // not NULL: init and store stats
