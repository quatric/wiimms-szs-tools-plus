...
typedef struct UsedObject_t
{
	u8 d[N_KMP_GOBJ];
} UsedObject_t;
typedef struct UsedFile_t
{
	u8 d[N_DB_FILE];
} UsedFile_t;
typedef struct UsedFileSZS_t
{
	u8 d[N_DB_FILE_SZS];
} UsedFileSZS_t;
typedef struct UsedFileSHA1_t
{
	u8 d[N_DB_FILE_SHA1];
} UsedFileSHA1_t;
typedef struct UsedFileFILE_t
{
	u8 d[N_DB_FILE_FILE];
} UsedFileFILE_t;
typedef struct UsedFileGROUP_t
{
	u8 d[N_DB_FILE_GROUP];
} UsedFileGROUP_t;
