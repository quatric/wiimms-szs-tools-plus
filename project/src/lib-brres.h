...
typedef int (*brsub_it_raw_func) (struct brsub_iterator_t *it, // iterator struct with all infos
	u8 *data, // data pointer
	u32 data_size // size of 'data'
);

typedef int (*brsub_it_grp_func) (struct brsub_iterator_t *it, // iterator struct with all infos
	brres_group_t *grp, // pointer to group
	uint grp_index // index of group
);

typedef int (*brsub_it_entry_func) (struct brsub_iterator_t *it, // iterator struct with all infos
	brres_group_t *grp, // pointer to group
	uint grp_index, // index of group
...
typedef int (*brsub_it_str_func) (struct brsub_iterator_t *it, // iterator struct with all infos
	u8 *base, // pointer to base for calculation
	u32 *ptr // pointer to u32 string offset
);

typedef int (*brsub_it_off_func) (struct brsub_iterator_t *it, // iterator struct with all infos
	u8 *base, // pointer to base for calculation
