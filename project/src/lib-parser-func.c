...
void DefineParserVars (VarMap_t *vm)
{
	...
	static const struct inttab_t inttab[] = { { "FALSE", 0 }, { "TRUE", 1 }, { "NO", 0 },
		{ "YES", 1 }, { "OFF", 0 }, { "ON", 1 }, { "DISABLED", 0 }, { "ENABLED", 1 },

		{ "INT$MIN", INT_MIN }, { "INT$MAX", INT_MAX },

		{ "TYPE$UNDEF", -1 }, { "TYPE$UNSET", VAR_UNSET }, { "TYPE$INT", VAR_INT },
		{ "TYPE$FLOAT", VAR_DOUBLE }, { "TYPE$VECTOR", VAR_VECTOR }, { "TYPE$STR", VAR_STRING },
		{ "TYPE$X", VAR_X }, { "TYPE$Y", VAR_Y }, { "TYPE$Z", VAR_Z },

		{ "TOOL$NUMTIME", BINTIME },
		//{ "TOOL$REVISION",	REVISION_NUM },
		{ "REVISION$TOOL", REVISION_NUM }, { "REVISION$SETUP", REVISION_NUM },
	...
	static const struct dbltab_t dbltab[] = { { "M$E", 2.7182818284590452354 }, // e
...
void DefineMkwVars (VarMap_t *vm)
{
	...
	static const struct inttab_t inttab[] = { { "N$NONE", RTL_N_NONE }, // Mode of Nintendo-Tracks
		{ "N$HIDE", RTL_N_HIDE }, { "N$SHOW", RTL_N_SHOW }, { "N$SWAP", RTL_N_SWAP },

		{ "N$F_HEX", RTL_N_F_HEX }, { "N$F_WII", RTL_N_F_WII },

		{ "N$F_RED1", RTL_N_F_RED1 }, { "N$F_RED", RTL_N_F_RED1 }, { "N$F_RED2", RTL_N_F_RED2 },
		{ "N$F_RED3", RTL_N_F_RED3 }, { "N$F_RED4", RTL_N_F_RED4 },
		{ "N$F_YELLOW", RTL_N_F_YELLOW }, { "N$F_GREEN", RTL_N_F_GREEN },
		{ "N$F_BLUE1", RTL_N_F_BLUE1 }, { "N$F_BLUE", RTL_N_F_BLUE1 },
		{ "N$F_BLUE2", RTL_N_F_BLUE2 }, { "N$F_WHITE", RTL_N_F_WHITE },
		{ "N$F_CLEAR", RTL_N_F_CLEAR },

		{ "SLOT$WAIT", SLOT_WAIT }, { "SLOT$RANDOM", SLOT_RANDOM },
		{ "SLOT$RND_ALL", LE_SLOT_RND_ALL }, { "SLOT$RND_ORIG", LE_SLOT_RND_ORIGINAL },
		{ "SLOT$RND_CUSTOM", LE_SLOT_RND_CUSTOM }, { "SLOT$RND_NEW", LE_SLOT_RND_NEW },

		{ "LE$F_NEW", G_LEFL_NEW }, { "LE$F_HEAD", G_LEFL_RND_HEAD },
		{ "LE$F_GROUP", G_LEFL_RND_GROUP }, { "LE$F_ALIAS", G_LEFL_ALIAS },
		{ "LE$F_TEXTURE", G_LEFL_TEXTURE }, { "LE$F_HIDDEN", G_LEFL_HIDDEN },

		{ "LE$DISABLE", LE_DISABLED }, { "LE$DISABLED", LE_DISABLED }, { "LE$ENABLE", LE_ENABLED },
		{ "LE$ENABLED", LE_ENABLED }, { "LE$ALTERABLE", LE_ALTERABLE },
		{ "LE$EXCLUDE", LE_EXCLUDED }, { "LE$EXCLUDED", LE_EXCLUDED },
		{ "LE$INCLUDE", LE_INCLUDED }, { "LE$INCLUDED", LE_INCLUDED }, { "LE$EXTENT", LE_EXTENT },
		{ "LE$EXTENDED", LE_EXTENT }, { "LE$REGION", LE_REGION },

		{ "LE$PRODUCTIVE", LPM_PRODUCTIVE }, { "LE$TESTING", LPM_TESTING },
		{ "LE$EXPERIMENTAL", LPM_EXPERIMENTAL }, { "LE$AUTOMATIC", LPM_AUTOMATIC },

		{ "LEX$CB_AUTO", -1 }, { "LEX$CB_TIMETRIAL", 14 }, { "LEX$CB_RESERVED1", 14 },
		{ "LEX$CB_RESERVED2", 15 },

		{ "LEX$OO_AUTO", LEX_OO_AUTO }, { "LEX$OO_OFFLINE", LEX_OO_OFFLINE },
		{ "LEX$OO_ONLINE", LEX_OO_ONLINE },

		{ "LEX$GM_AUTO", LEX_GMODE_AUTO }, { "LEX$GM_STANDARD", LEX_GMODE_STD },
		{ "LEX$GM_STD", LEX_GMODE_STD }, { "LEX$GM_BALLOON", LEX_GMODE_BALLOON },
		{ "LEX$GM_COIN", LEX_GMODE_COIN }, { "LEX$GM_VERSUS", LEX_GMODE_VERSUS },
		{ "LEX$GM_ITEMRAIN", LEX_GMODE_ITEMRAIN },

		{ "LEX$EN_AUTO", LEX_ENGINE_AUTO }, { "LEX$EN_BATTLE", LEX_ENGINE_BATTLE },
		{ "LEX$EN_50CC", LEX_ENGINE_50 }, { "LEX$EN_100CC", LEX_ENGINE_100 },
		{ "LEX$EN_150CC", LEX_ENGINE_150 }, { "LEX$EN_200CC", LEX_ENGINE_200 },
		{ "LEX$EN_150M", LEX_ENGINE_150M }, { "LEX$EN_200M", LEX_ENGINE_200M },

		{ "RITP$OFF", RITP_MODE_OFF }, { "RITP$START", RITP_MODE_START },
		// [[new-ritp-mode]]

		{ "VEH$SMALL", CHATVEH_SMALL }, { "VEH$MEDIUM", CHATVEH_MEDIUM },
		{ "VEH$LARGE", CHATVEH_LARGE }, { "VEH$ANY_SIZE", CHATVEH_ANY_SIZE },
		{ "VEH$KART", CHATVEH_KART }, { "VEH$OUT_BIKE", CHATVEH_OUT_BIKE },
		{ "VEH$IN_BIKE", CHATVEH_IN_BIKE }, { "VEH$BIKE", CHATVEH_BIKE },
		{ "VEH$ANY_TYPE", CHATVEH_ANY_TYPE }, { "VEH$ANY", CHATVEH_ANY },

		{ "CHAT$OFF", CHATMD_OFF }, { "CHAT$ANY_TRACK", CHATMD_ANY_TRACK },
		{ "CHAT$TRACK_BY_HOST", CHATMD_TRACK_BY_HOST }, { "CHAT$BLOCK_CLEAR", CHATMD_BLOCK_CLEAR },
		{ "CHAT$BLOCK_DISABLE", CHATMD_BLOCK_DISABLE },
		{ "CHAT$BLOCK_ENABLE", CHATMD_BLOCK_ENABLE }, { "CHAT$ANY_VEHICLE", CHATMD_ANY_VEHICLE },
		{ "CHAT$KARTS_ONLY", CHATMD_KARTS_ONLY }, { "CHAT$BIKES_ONLY", CHATMD_BIKES_ONLY },
		{ "CHAT$RESET_ENGINE", CHATMD_RESET_ENGINE }, { "CHAT$USE_ENGINE_1", CHATMD_USE_ENGINE_1 },
		{ "CHAT$USE_ENGINE_2", CHATMD_USE_ENGINE_2 }, { "CHAT$USE_ENGINE_3", CHATMD_USE_ENGINE_3 },
...
static enumError F_dollar (struct Var_t *res, // store result here
...
static enumError F_echo (struct Var_t *res, // store result here
	struct Var_t *param, // parameters, modified
	uint n_param, // number of parameters
	struct ScanInfo_t *si, // not NULL: use for error messages
	const FuncParam_t *fpar // pointer to user parameter
...
static enumError F_line (struct Var_t *res, // store result here
	struct Var_t *param, // parameters, modified
	uint n_param, // number of parameters
	struct ScanInfo_t *si, // not NULL: use for error messages
	const FuncParam_t *fpar // pointer to user parameter
...
static enumError F_sourceLevel (struct Var_t *res, // store result here
	struct Var_t *param, // parameters, modified
	uint n_param, // number of parameters
	struct ScanInfo_t *si, // not NULL: use for error messages
	const FuncParam_t *fpar // pointer to user parameter
...
static enumError F_ifLevel (struct Var_t *res, // store result here
	struct Var_t *param, // parameters, modified
	uint n_param, // number of parameters
	struct ScanInfo_t *si, // not NULL: use for error messages
	const FuncParam_t *fpar // pointer to user parameter
...
static enumError F_loopLevel (struct Var_t *res, // store result here
	struct Var_t *param, // parameters, modified
	uint n_param, // number of parameters
	struct ScanInfo_t *si, // not NULL: use for error messages
	const FuncParam_t *fpar // pointer to user parameter
...
static enumError F_loopCount (struct Var_t *res, // store result here
	struct Var_t *param, // parameters, modified
	uint n_param, // number of parameters
	struct ScanInfo_t *si, // not NULL: use for error messages
	const FuncParam_t *fpar // pointer to user parameter
...
static enumError F_status (struct Var_t *res, // store result here
	struct Var_t *param, // parameters, modified
	uint n_param, // number of parameters
	struct ScanInfo_t *si, // not NULL: use for error messages
	const FuncParam_t *fpar // pointer to user parameter
...
static enumError F_isLEX (struct Var_t *res, // store result here
	struct Var_t *param, // parameters, modified
	uint n_param, // number of parameters
	struct ScanInfo_t *si, // not NULL: use for error messages
	const FuncParam_t *fpar // pointer to user parameter
...
static enumError F_isMDL (struct Var_t *res, // store result here
	struct Var_t *param, // parameters, modified
	uint n_param, // number of parameters
	struct ScanInfo_t *si, // not NULL: use for error messages
	const FuncParam_t *fpar // pointer to user parameter
...
static enumError F_call_macro (struct Var_t *res, // store result here
	struct Var_t *param, // parameters, modified
	uint n_param, // number of parameters
	struct ScanInfo_t *si, // not NULL: use for error messages
	const FuncParam_t *fpar // pointer to user parameter
)
{
	...
	{
		si->total_err++;
		ERROR0 (ERR_WARNING, "To many nested function calls (max=%u) [%s @%u]\n",
	...
	ScanFile_t *newsf = AddSF (si, macro->data, macro->data_size, macro->src_name, sf->revision, 0);
	DASSERT (newsf);
...
static enumError F_result (struct Var_t *res, // store result here
	struct Var_t *param, // parameters, modified
	uint n_param, // number of parameters
	struct ScanInfo_t *si, // not NULL: use for error messages
	const FuncParam_t *fpar // pointer to user parameter
...
static enumError F_param (struct Var_t *res, // store result here
	struct Var_t *param, // parameters, modified
	uint n_param, // number of parameters
	struct ScanInfo_t *si, // not NULL: use for error messages
	const FuncParam_t *fpar // pointer to user parameter
...
static enumError F_isMacro (struct Var_t *res, // store result here
	struct Var_t *param, // parameters, modified
	uint n_param, // number of parameters
	struct ScanInfo_t *si, // not NULL: use for error messages
	const FuncParam_t *fpar // pointer to user parameter
...
static enumError F_isFunction (struct Var_t *res, // store result here
	struct Var_t *param, // parameters, modified
	uint n_param, // number of parameters
	struct ScanInfo_t *si, // not NULL: use for error messages
	const FuncParam_t *fpar // pointer to user parameter
...
static const Var_t *find_var (ScanInfo_t *si, char *name, int *xyz)
{
	...
	if (nlen > 2 && name[nlen - 2] == '.' && name[nlen - 1] >= 'X' && name[nlen - 1] <= 'Z')
	{
		name[nlen - 2] = 0;
...
static enumError F_isDef (struct Var_t *res, // store result here
	struct Var_t *param, // parameters, modified
	uint n_param, // number of parameters
	struct ScanInfo_t *si, // not NULL: use for error messages
	const FuncParam_t *fpar // pointer to user parameter
...
static enumError F_isInt (struct Var_t *res, // store result here
	struct Var_t *param, // parameters, modified
	uint n_param, // number of parameters
	struct ScanInfo_t *si, // not NULL: use for error messages
	const FuncParam_t *fpar // pointer to user parameter
...
static enumError F_isFloat (struct Var_t *res, // store result here
	struct Var_t *param, // parameters, modified
	uint n_param, // number of parameters
	struct ScanInfo_t *si, // not NULL: use for error messages
	const FuncParam_t *fpar // pointer to user parameter
...
static enumError F_isVector (struct Var_t *res, // store result here
	struct Var_t *param, // parameters, modified
	uint n_param, // number of parameters
	struct ScanInfo_t *si, // not NULL: use for error messages
	const FuncParam_t *fpar // pointer to user parameter
...
static enumError F_isScalar (struct Var_t *res, // store result here
	struct Var_t *param, // parameters, modified
	uint n_param, // number of parameters
	struct ScanInfo_t *si, // not NULL: use for error messages
	const FuncParam_t *fpar // pointer to user parameter
...
static enumError F_isNumeric (struct Var_t *res, // store result here
	struct Var_t *param, // parameters, modified
	uint n_param, // number of parameters
	struct ScanInfo_t *si, // not NULL: use for error messages
	const FuncParam_t *fpar // pointer to user parameter
...
static enumError F_isStr (struct Var_t *res, // store result here
	struct Var_t *param, // parameters, modified
	uint n_param, // number of parameters
	struct ScanInfo_t *si, // not NULL: use for error messages
	const FuncParam_t *fpar // pointer to user parameter
...
static enumError F_type (struct Var_t *res, // store result here
	struct Var_t *param, // parameters, modified
	uint n_param, // number of parameters
	struct ScanInfo_t *si, // not NULL: use for error messages
	const FuncParam_t *fpar // pointer to user parameter
...
static enumError F_var (struct Var_t *res, // store result here
	struct Var_t *param, // parameters, modified
	uint n_param, // number of parameters
	struct ScanInfo_t *si, // not NULL: use for error messages
	const FuncParam_t *fpar // pointer to user parameter
...
static enumError F_int (struct Var_t *res, // store result here
	struct Var_t *param, // parameters, modified
	uint n_param, // number of parameters
	struct ScanInfo_t *si, // not NULL: use for error messages
	const FuncParam_t *fpar // pointer to user parameter
...
static enumError F_float (struct Var_t *res, // store result here
	struct Var_t *param, // parameters, modified
	uint n_param, // number of parameters
	struct ScanInfo_t *si, // not NULL: use for error messages
	const FuncParam_t *fpar // pointer to user parameter
...
static enumError F_scalar (struct Var_t *res, // store result here
	struct Var_t *param, // parameters, modified
	uint n_param, // number of parameters
	struct ScanInfo_t *si, // not NULL: use for error messages
	const FuncParam_t *fpar // pointer to user parameter
...
static enumError F_str (struct Var_t *res, // store result here
	struct Var_t *param, // parameters, modified
	uint n_param, // number of parameters
	struct ScanInfo_t *si, // not NULL: use for error messages
	const FuncParam_t *fpar // pointer to user parameter
...
static enumError F_scanval (struct Var_t *res, // store result here
	struct Var_t *param, // parameters, modified
	uint n_param, // number of parameters
	struct ScanInfo_t *si, // not NULL: use for error messages
	const FuncParam_t *fpar // pointer to user parameter
...
static enumError F_scanexpr (struct Var_t *res, // store result here
	struct Var_t *param, // parameters, modified
	uint n_param, // number of parameters
	struct ScanInfo_t *si, // not NULL: use for error messages
	const FuncParam_t *fpar // pointer to user parameter
...
static enumError F_be (struct Var_t *res, // store result here
	struct Var_t *param, // parameters, modified
	uint n_param, // number of parameters
	struct ScanInfo_t *si, // not NULL: use for error messages
	const FuncParam_t *fpar // pointer to user parameter
)
{
	...
	{
		case 1:
			res->int_mode = IMD_BE1;
			i &= 0xff;
			break;
		case 2:
			res->int_mode = IMD_BE2;
			i &= 0xffff;
			break;
		case 3:
			res->int_mode = IMD_BE3;
			i &= 0xffffff;
			break;
		case 4:
			res->int_mode = IMD_BE4;
			i &= 0xffffffff;
			break;
		case 5:
			res->int_mode = IMD_BE5;
			i &= 0xffffffffff;
			break;
		case 6:
			res->int_mode = IMD_BE6;
			i &= 0xffffffffffff;
			break;
		case 7:
			res->int_mode = IMD_BE7;
			i &= 0xffffffffffffff;
			break;
		case 8:
			res->int_mode = IMD_BE8;
			break;
		default:
			res->int_mode = IMD_BE0;
			break;
	}
	res->i = i;
	res->mode = VAR_INT;
...
static enumError F_le (struct Var_t *res, // store result here
	struct Var_t *param, // parameters, modified
	uint n_param, // number of parameters
	struct ScanInfo_t *si, // not NULL: use for error messages
	const FuncParam_t *fpar // pointer to user parameter
)
{
	...
	{
		case 1:
			res->int_mode = IMD_LE1;
			i &= 0xff;
			break;
		case 2:
			res->int_mode = IMD_LE2;
			i &= 0xffff;
			break;
		case 3:
			res->int_mode = IMD_LE3;
			i &= 0xffffff;
			break;
		case 4:
			res->int_mode = IMD_LE4;
			i &= 0xffffffff;
			break;
		case 5:
			res->int_mode = IMD_LE5;
			i &= 0xffffffffff;
			break;
		case 6:
			res->int_mode = IMD_LE6;
			i &= 0xffffffffffff;
			break;
		case 7:
			res->int_mode = IMD_LE7;
			i &= 0xffffffffffffff;
			break;
		case 8:
			res->int_mode = IMD_LE8;
			break;
		default:
			res->int_mode = IMD_LE0;
			break;
	}
	res->i = i;
	res->mode = VAR_INT;
...
static enumError F_select (struct Var_t *res, // store result here
	struct Var_t *param, // parameters, modified
	uint n_param, // number of parameters
	struct ScanInfo_t *si, // not NULL: use for error messages
	const FuncParam_t *fpar // pointer to user parameter
...
static enumError extract_beg (struct Var_t *res, // store result here
...
static enumError F_left (struct Var_t *res, // store result here
	struct Var_t *param, // parameters, modified
	uint n_param, // number of parameters
	struct ScanInfo_t *si, // not NULL: use for error messages
	const FuncParam_t *fpar // pointer to user parameter
...
static enumError F_right (struct Var_t *res, // store result here
	struct Var_t *param, // parameters, modified
	uint n_param, // number of parameters
	struct ScanInfo_t *si, // not NULL: use for error messages
	const FuncParam_t *fpar // pointer to user parameter
...
static enumError F_mid (struct Var_t *res, // store result here
	struct Var_t *param, // parameters, modified
	uint n_param, // number of parameters
	struct ScanInfo_t *si, // not NULL: use for error messages
	const FuncParam_t *fpar // pointer to user parameter
)
{
	...
	int p2 = n_param > 2 && param[2].mode != VAR_UNSET ? GetIntV (param + 2) : param->str_len;
	if (p2 >= 0)
		p2 += p1;
...
static enumError F_extract (struct Var_t *res, // store result here
	struct Var_t *param, // parameters, modified
	uint n_param, // number of parameters
	struct ScanInfo_t *si, // not NULL: use for error messages
	const FuncParam_t *fpar // pointer to user parameter
...
static enumError F_remove (struct Var_t *res, // store result here
	struct Var_t *param, // parameters, modified
	uint n_param, // number of parameters
	struct ScanInfo_t *si, // not NULL: use for error messages
	const FuncParam_t *fpar // pointer to user parameter
...
static enumError F_print (struct Var_t *res, // store result here
	struct Var_t *param, // parameters, modified
	uint n_param, // number of parameters
	struct ScanInfo_t *si, // not NULL: use for error messages
	const FuncParam_t *fpar // pointer to user parameter
)
{
			...
			if (*f == '$')
			{
				...
				else if (warnings)
				{
					...
					ERROR0 (ERR_WARNING,
						...
						pp.n - 1, sf->name, sf->line, (int)(f - format + 2), format - 1);
				}
				format = f + 1;
			}
		}
	...
	end_scan_variants:
		...
		noPRINT ("FORMAT |%.*s| '%c' alt=%d, grp=%d, pad=%c, left=%d, sign%s=%c,"
			...
			(int)(format - flags_begin), flags_begin, convert, alternative, grouping, padding,
			left_adjust, right_sign ? "/r" : "", sign ? sign : '0', fw, prec, force_vector,
			enclose_vector, pp.index, pp.max_index, pp.n);
					...
					|| (force_vector ? v->mode == VAR_VECTOR : v->mode == VAR_DOUBLE))
				{
					...
					*fptr = 0;
					...
					if (force_vector || v->mode == VAR_VECTOR)
					{
						...
						dest = snprintfE (dest, buf + sizeof (buf), fbuf, v->x);
						*dest++ = ',';
						dest = snprintfE (dest, buf + sizeof (buf), fbuf, v->y);
						*dest++ = ',';
			...
			case 's':
				if (!mode_must_match || v->mode == VAR_STRING)
				{
					...
					if (quote || alternative)
					{
						...
						PrintEscapedString (
							buf + 1, sizeof (buf) - 5, v->str, v->str_len, CHMD__ALL, '"', &len);
						if (quote)
						{
							str = buf;
							*buf = '"';
	...
	if (warnings)
	{
		...
		if (pp.max_index >= pp.n)
			ERROR0 (ERR_WARNING, "Access to non existing argument [%s @%u]: %s\n", sf->name,
				sf->line, param->str);
		else if (pp.max_index < pp.n - 1 && !pp.select)
			ERROR0 (ERR_WARNING, "Only %u of %u arguments used [%s @%u]: %s\n", pp.max_index,
				pp.n - 1, sf->name, sf->line, param->str);
	}
...
static enumError F_sec (struct Var_t *res, // store result here
	struct Var_t *param, // parameters, modified
	uint n_param, // number of parameters
	struct ScanInfo_t *si, // not NULL: use for error messages
	const FuncParam_t *fpar // pointer to user parameter
...
static enumError F_mSec (struct Var_t *res, // store result here
	struct Var_t *param, // parameters, modified
	uint n_param, // number of parameters
	struct ScanInfo_t *si, // not NULL: use for error messages
	const FuncParam_t *fpar // pointer to user parameter
...
static enumError F_uSec (struct Var_t *res, // store result here
	struct Var_t *param, // parameters, modified
	uint n_param, // number of parameters
	struct ScanInfo_t *si, // not NULL: use for error messages
	const FuncParam_t *fpar // pointer to user parameter
...
static enumError F_v (struct Var_t *res, // store result here
	struct Var_t *param, // parameters, modified
	uint n_param, // number of parameters
	struct ScanInfo_t *si, // not NULL: use for error messages
	const FuncParam_t *fpar // pointer to user parameter
...
static enumError F_v3 (struct Var_t *res, // store result here
	struct Var_t *param, // parameters, modified
	uint n_param, // number of parameters
	struct ScanInfo_t *si, // not NULL: use for error messages
	const FuncParam_t *fpar // pointer to user parameter
...
static enumError F_vx (struct Var_t *res, // store result here
	struct Var_t *param, // parameters, modified
	uint n_param, // number of parameters
	struct ScanInfo_t *si, // not NULL: use for error messages
	const FuncParam_t *fpar // pointer to user parameter
...
static enumError F_vy (struct Var_t *res, // store result here
	struct Var_t *param, // parameters, modified
	uint n_param, // number of parameters
	struct ScanInfo_t *si, // not NULL: use for error messages
	const FuncParam_t *fpar // pointer to user parameter
...
static enumError F_vz (struct Var_t *res, // store result here
	struct Var_t *param, // parameters, modified
	uint n_param, // number of parameters
	struct ScanInfo_t *si, // not NULL: use for error messages
	const FuncParam_t *fpar // pointer to user parameter
...
static enumError F_vd (struct Var_t *res, // store result here
	struct Var_t *param, // parameters, modified
	uint n_param, // number of parameters
	struct ScanInfo_t *si, // not NULL: use for error messages
	const FuncParam_t *fpar // pointer to user parameter
...
static enumError F_x (struct Var_t *res, // store result here
	struct Var_t *param, // parameters, modified
	uint n_param, // number of parameters
	struct ScanInfo_t *si, // not NULL: use for error messages
	const FuncParam_t *fpar // pointer to user parameter
...
static enumError F_sideOfLine (struct Var_t *res, // store result here
	struct Var_t *param, // parameters, modified
	uint n_param, // number of parameters
	struct ScanInfo_t *si, // not NULL: use for error messages
	const FuncParam_t *fpar // pointer to user parameter
...
static enumError F_ptInConvexPolygon (struct Var_t *res, // store result here
	struct Var_t *param, // parameters, modified
	uint n_param, // number of parameters
	struct ScanInfo_t *si, // not NULL: use for error messages
	const FuncParam_t *fpar // pointer to user parameter
...
static enumError F_ptsInConvexTri (struct Var_t *res, // store result here
	struct Var_t *param, // parameters, modified
	uint n_param, // number of parameters
	struct ScanInfo_t *si, // not NULL: use for error messages
	const FuncParam_t *fpar // pointer to user parameter
...
static enumError F_ptsInConvexQuad (struct Var_t *res, // store result here
	struct Var_t *param, // parameters, modified
	uint n_param, // number of parameters
	struct ScanInfo_t *si, // not NULL: use for error messages
	const FuncParam_t *fpar // pointer to user parameter
...
static enumError F_dot (struct Var_t *res, // store result here
	struct Var_t *param, // parameters, modified
	uint n_param, // number of parameters
	struct ScanInfo_t *si, // not NULL: use for error messages
	const FuncParam_t *fpar // pointer to user parameter
...
static enumError F_cross (struct Var_t *res, // store result here
	struct Var_t *param, // parameters, modified
	uint n_param, // number of parameters
	struct ScanInfo_t *si, // not NULL: use for error messages
	const FuncParam_t *fpar // pointer to user parameter
...
static enumError F_unit (struct Var_t *res, // store result here
	struct Var_t *param, // parameters, modified
	uint n_param, // number of parameters
	struct ScanInfo_t *si, // not NULL: use for error messages
	const FuncParam_t *fpar // pointer to user parameter
...
static enumError F_calcNormals (struct Var_t *res, // store result here
	struct Var_t *param, // parameters, modified
	uint n_param, // number of parameters
	struct ScanInfo_t *si, // not NULL: use for error messages
	const FuncParam_t *fpar // pointer to user parameter
...
static enumError F_getNormal (struct Var_t *res, // store result here
	struct Var_t *param, // parameters, modified
	uint n_param, // number of parameters
	struct ScanInfo_t *si, // not NULL: use for error messages
	const FuncParam_t *fpar // pointer to user parameter
...
static enumError F_len (struct Var_t *res, // store result here
	struct Var_t *param, // parameters, modified
	uint n_param, // number of parameters
	struct ScanInfo_t *si, // not NULL: use for error messages
	const FuncParam_t *fpar // pointer to user parameter
)
{
	...
	if (n_param > 1)
	{
		...
		res->d = param->x * param->x + param->y * param->y + param->z * param->z;
...
static enumError F_hLen (struct Var_t *res, // store result here
	struct Var_t *param, // parameters, modified
	uint n_param, // number of parameters
	struct ScanInfo_t *si, // not NULL: use for error messages
	const FuncParam_t *fpar // pointer to user parameter
...
static enumError F_pos (struct Var_t *res, // store result here
	struct Var_t *param, // parameters, modified
	uint n_param, // number of parameters
	struct ScanInfo_t *si, // not NULL: use for error messages
	const FuncParam_t *fpar // pointer to user parameter
...
static enumError F_bezier (struct Var_t *res, // store result here
	struct Var_t *param, // parameters, modified
	uint n_param, // number of parameters
	struct ScanInfo_t *si, // not NULL: use for error messages
	const FuncParam_t *fpar // pointer to user parameter
)
{
	...
	if (n_param >= 5)
	{
		...
		for (dim = 0; dim < n_dim; dim++, t++)
		{
			...
			*r++ = t2 * t2 * t2 * *p1++ + 3 * *t * t2 * t2 * *pa++ + 3 * *t * *t * t2 * *pb++
				+ *t * *t * *t * *p2++;
		}
	}
	else
...
static enumError F_rot (struct Var_t *res, // store result here
	struct Var_t *param, // parameters, modified
	uint n_param, // number of parameters
	struct ScanInfo_t *si, // not NULL: use for error messages
	const FuncParam_t *fpar // pointer to user parameter
...
static enumError F_axisRot (struct Var_t *res, // store result here
	struct Var_t *param, // parameters, modified
	uint n_param, // number of parameters
	struct ScanInfo_t *si, // not NULL: use for error messages
	const FuncParam_t *fpar // pointer to user parameter
...
static enumError F_aDir (struct Var_t *res, // store result here
	struct Var_t *param, // parameters, modified
	uint n_param, // number of parameters
	struct ScanInfo_t *si, // not NULL: use for error messages
	const FuncParam_t *fpar // pointer to user parameter
)
{
	...
	if (n_param > 1)
	{
		ToVectorV (param + 1);
		res->d
			= atan2 (param[1].v[a] - param[0].v[a], param[1].v[b] - param[0].v[b]) * (180 / M_PI);
	}
	else
...
static enumError F_dir (struct Var_t *res, // store result here
	struct Var_t *param, // parameters, modified
	uint n_param, // number of parameters
	struct ScanInfo_t *si, // not NULL: use for error messages
	const FuncParam_t *fpar // pointer to user parameter
...
static enumError F_ptsInCuboid (struct Var_t *res, // store result here
	struct Var_t *param, // parameters, modified
	uint n_param, // number of parameters
	struct ScanInfo_t *si, // not NULL: use for error messages
	const FuncParam_t *fpar // pointer to user parameter
)
{
	...
	if (!fpar->user_id)
	{
		...
		{
			ToVectorV (ptr);
			if (ptr->x >= param[0].x && ptr->x <= param[1].x && ptr->y >= param[0].y
				&& ptr->y <= param[1].y && ptr->z >= param[0].z && ptr->z <= param[1].z)
			{
				count++;
			}
		}
	...
	else
	{
		...
		{
			ToVectorV (ptr);
			if ((param[0].x < param[1].x ? ptr->x >= param[0].x && ptr->x <= param[1].x
										 : ptr->x >= param[1].x && ptr->x <= param[0].x)
				&& (param[0].y < param[1].y ? ptr->y >= param[0].y && ptr->y <= param[1].y
											: ptr->y >= param[1].y && ptr->y <= param[0].y)
				&& (param[0].z < param[1].z ? ptr->z >= param[0].z && ptr->z <= param[1].z
...
static enumError F_OverlapCubeTri (struct Var_t *res, // store result here
	struct Var_t *param, // parameters, modified
	uint n_param, // number of parameters
	struct ScanInfo_t *si, // not NULL: use for error messages
	const FuncParam_t *fpar // pointer to user parameter
)
{
	...
	res->i = OverlapCubeTri (&ToVectorV (param + 0)->d3, GetDoubleV (param + 1),
		&ToVectorV (param + 2)->d3, &ToVectorV (param + 3)->d3, &ToVectorV (param + 4)->d3);
	res->mode = VAR_INT;
	return ERR_OK;
}
...
static enumError F_abs (struct Var_t *res, // store result here
	struct Var_t *param, // parameters, modified
	uint n_param, // number of parameters
	struct ScanInfo_t *si, // not NULL: use for error messages
	const FuncParam_t *fpar // pointer to user parameter
...
static enumError F_sign (struct Var_t *res, // store result here
	struct Var_t *param, // parameters, modified
	uint n_param, // number of parameters
	struct ScanInfo_t *si, // not NULL: use for error messages
	const FuncParam_t *fpar // pointer to user parameter
...
static enumError F_min (struct Var_t *res, // store result here
	struct Var_t *param, // parameters, modified
	uint n_param, // number of parameters
	struct ScanInfo_t *si, // not NULL: use for error messages
	const FuncParam_t *fpar // pointer to user parameter
...
static enumError F_max (struct Var_t *res, // store result here
	struct Var_t *param, // parameters, modified
	uint n_param, // number of parameters
	struct ScanInfo_t *si, // not NULL: use for error messages
	const FuncParam_t *fpar // pointer to user parameter
...
static enumError F_minMax (struct Var_t *res, // store result here
	struct Var_t *param, // parameters, modified
	uint n_param, // number of parameters
	struct ScanInfo_t *si, // not NULL: use for error messages
	const FuncParam_t *fpar // pointer to user parameter
...
static enumError F_mean (struct Var_t *res, // store result here
	struct Var_t *param, // parameters, modified
	uint n_param, // number of parameters
	struct ScanInfo_t *si, // not NULL: use for error messages
	const FuncParam_t *fpar // pointer to user parameter
...
static enumError F_trunc (struct Var_t *res, // store result here
	struct Var_t *param, // parameters, modified
	uint n_param, // number of parameters
	struct ScanInfo_t *si, // not NULL: use for error messages
	const FuncParam_t *fpar // pointer to user parameter
...
static enumError F_floor (struct Var_t *res, // store result here
	struct Var_t *param, // parameters, modified
	uint n_param, // number of parameters
	struct ScanInfo_t *si, // not NULL: use for error messages
	const FuncParam_t *fpar // pointer to user parameter
...
static enumError F_ceil (struct Var_t *res, // store result here
	struct Var_t *param, // parameters, modified
	uint n_param, // number of parameters
	struct ScanInfo_t *si, // not NULL: use for error messages
	const FuncParam_t *fpar // pointer to user parameter
...
static enumError F_round (struct Var_t *res, // store result here
	struct Var_t *param, // parameters, modified
	uint n_param, // number of parameters
	struct ScanInfo_t *si, // not NULL: use for error messages
	const FuncParam_t *fpar // pointer to user parameter
...
static enumError F_sqrt (struct Var_t *res, // store result here
	struct Var_t *param, // parameters, modified
	uint n_param, // number of parameters
	struct ScanInfo_t *si, // not NULL: use for error messages
	const FuncParam_t *fpar // pointer to user parameter
...
static enumError F_log (struct Var_t *res, // store result here
	struct Var_t *param, // parameters, modified
	uint n_param, // number of parameters
	struct ScanInfo_t *si, // not NULL: use for error messages
	const FuncParam_t *fpar // pointer to user parameter
...
static enumError F_exp (struct Var_t *res, // store result here
	struct Var_t *param, // parameters, modified
	uint n_param, // number of parameters
	struct ScanInfo_t *si, // not NULL: use for error messages
	const FuncParam_t *fpar // pointer to user parameter
...
static enumError F_pow (struct Var_t *res, // store result here
	struct Var_t *param, // parameters, modified
	uint n_param, // number of parameters
	struct ScanInfo_t *si, // not NULL: use for error messages
	const FuncParam_t *fpar // pointer to user parameter
...
static enumError F_random (struct Var_t *res, // store result here
	struct Var_t *param, // parameters, modified
	uint n_param, // number of parameters
	struct ScanInfo_t *si, // not NULL: use for error messages
	const FuncParam_t *fpar // pointer to user parameter
...
static enumError F_sin (struct Var_t *res, // store result here
	struct Var_t *param, // parameters, modified
	uint n_param, // number of parameters
	struct ScanInfo_t *si, // not NULL: use for error messages
	const FuncParam_t *fpar // pointer to user parameter
...
static enumError F_cos (struct Var_t *res, // store result here
	struct Var_t *param, // parameters, modified
	uint n_param, // number of parameters
	struct ScanInfo_t *si, // not NULL: use for error messages
	const FuncParam_t *fpar // pointer to user parameter
...
static enumError F_tan (struct Var_t *res, // store result here
	struct Var_t *param, // parameters, modified
	uint n_param, // number of parameters
	struct ScanInfo_t *si, // not NULL: use for error messages
	const FuncParam_t *fpar // pointer to user parameter
...
static enumError F_asin (struct Var_t *res, // store result here
	struct Var_t *param, // parameters, modified
	uint n_param, // number of parameters
	struct ScanInfo_t *si, // not NULL: use for error messages
	const FuncParam_t *fpar // pointer to user parameter
...
static enumError F_acos (struct Var_t *res, // store result here
	struct Var_t *param, // parameters, modified
	uint n_param, // number of parameters
	struct ScanInfo_t *si, // not NULL: use for error messages
	const FuncParam_t *fpar // pointer to user parameter
...
static enumError F_atan (struct Var_t *res, // store result here
	struct Var_t *param, // parameters, modified
	uint n_param, // number of parameters
	struct ScanInfo_t *si, // not NULL: use for error messages
	const FuncParam_t *fpar // pointer to user parameter
...
static enumError F_atan2 (struct Var_t *res, // store result here
	struct Var_t *param, // parameters, modified
	uint n_param, // number of parameters
	struct ScanInfo_t *si, // not NULL: use for error messages
	const FuncParam_t *fpar // pointer to user parameter
...
static enumError F_if_engine (struct Var_t *res, // store result here
	struct Var_t *param, // parameters, modified
	uint n_param, // number of parameters
	struct ScanInfo_t *si, // not NULL: use for error messages
	const FuncParam_t *fpar // pointer to user parameter
...
static enumError F_if_random (struct Var_t *res, // store result here
	struct Var_t *param, // parameters, modified
	uint n_param, // number of parameters
	struct ScanInfo_t *si, // not NULL: use for error messages
	const FuncParam_t *fpar // pointer to user parameter
...
static enumError F_if_test (struct Var_t *res, // store result here
	struct Var_t *param, // parameters, modified
	uint n_param, // number of parameters
	struct ScanInfo_t *si, // not NULL: use for error messages
	const FuncParam_t *fpar // pointer to user parameter
)
{
	...
	res->i = GOBJ_MIN_COND_TEST | (GetIntV (param + 0) & 0x0f) << 6
...
static enumError F_chat_n_races (struct Var_t *res, // store result here
	struct Var_t *param, // parameters, modified
	uint n_param, // number of parameters
	struct ScanInfo_t *si, // not NULL: use for error messages
	const FuncParam_t *fpar // pointer to user parameter
...
static enumError F_chat_vehicles (struct Var_t *res, // store result here
	struct Var_t *param, // parameters, modified
	uint n_param, // number of parameters
	struct ScanInfo_t *si, // not NULL: use for error messages
	const FuncParam_t *fpar // pointer to user parameter
...
static const struct FuncTable_t func_tab[] = { //----- management
	...
	{ 0, 0, "STATUS", F_status, 0, "int", "status()",
	...
	{ -1, 1, "ISMACRO", F_isMacro, 0, "int", "isMacro(name)",
	...
	{ -1, 1, "ISFUNCTION", F_isFunction, 0, "int", "isFunction(name)",
	...
	{ 1, 1, "STR", F_str, 0, "str", "str(val)", "Converts 'val' to a string value." },

	{ 1, 1, "SCANVAL", F_scanval, 0, "*", "scanVal(val)",
		"If 'val' is a string, scan it for a value."
		" Otherwise return 'val'." },

	{ 1, 1, "SCANEXPR", F_scanexpr, 0, "*", "scanExpr(val)",
		"If 'val' is a string, scan it for an expression."
		" Otherwise return 'val'." },

	//---- endian support

	{ 2, 2, "BE", F_be, 0, "int", "be(val,n)",
		"Convert 'val' to integer, limit it to 'n' bytes (1-8)"
		" and mark it for big endian usage." },

	{ 2, 2, "LE", F_le, 0, "int", "le(val,n)",
		"Convert 'val' to integer, limit it to 'n' bytes (1-8)"
		" and mark it for little endian usage." },

	//----- access functions

	{ 2, MAX_FUNC_PARAM, "SELECT", F_select, 0, "*", "select(sel,p0,p1,...,pN)",
	...
	{ 3, 3, "EXTRACT", F_extract, 0, "str", "extract(str,pos1,pos2)",
	...
	{ 1, 1, "V3", F_v3, 0, "vector", "v3(val)",
		"Create a vector with all 3 components equal to 'val'" },

	{ 1, 2, "VX", F_vx, 0, "vector", "vx(x[,v])",
	...
	{ 1, MAX_FUNC_PARAM, "Y", F_x, 1, "float", "y(val_1,...,val_n)",
		"Scan all parameters (at least 1 must exist) and find the first vector."
	...
	{ 1, MAX_FUNC_PARAM, "Z", F_x, 2, "float", "z(val_1,...,val_n)",
		"Scan all parameters (at least 1 must exist) and find the first vector."
	...
	{ 3, 3, "SIDEOFLINE", F_sideOfLine, 0, "int", "sideOfLine(a,b,pt)",
	...
	{ 4, 101, "PTINCONVEXPOLYGON", F_ptInConvexPolygon, 0, "int", "ptInConvexPolygon(pt,p1,..,pN)",
		"All parameters are converted into vectors,"
		" but only the x and z coordinates are used."
	...
	{ 4, 103, "PTSINCONVEXTRI", F_ptsInConvexTri, 0, "int", "ptsInConvexTri(t1,t2,t3,pt1,...,ptN)",
		"All parameters are converted into vectors,"
		" but only the x and z coordinates are used."
	...
	{ 5, 104, "PTSINCONVEXQUAD", F_ptsInConvexQuad, 0, "int",
		"ptsInConvexQuad(q1,q2,q3,q4,pt1,...,ptN)",
		"All parameters are converted into vectors,"
		" but only the x and z coordinates are used."
	...
	{ 1, 2, "HLEN2", F_hLen, 2, "float", "hLen2(v1[,v2])",
	...
	{ 3, 3, "POS", F_pos, 0, "flt|vec", "pos(pos,p1,p2)",
	...
	{ 4, 5, "BEZIER", F_bezier, 0, "flt|vec", "bezier(pos,v1,va[,vb],v2)",
	...
	{ 2, 3, "XROT", F_xRot, 0, "vector", "xRot(pt,deg[,origin])",
	...
	{ 2, 3, "YROT", F_xRot, 1, "vector", "yRot(pt,deg[,origin])",
	...
	{ 4, 4, "AXISROT", F_axisRot, 0, "vector", "axisRot(pt,deg,axis1,axis2)",
	...
	{ 1, 2, "XDIR", F_aDir, 0, "float", "xDir([v1,]v2)",
	...
	{ 3, MAX_FUNC_PARAM, "PTSINCUBOIDS", F_ptsInCuboid, 1, "int",
		"ptsInCuboidS(cube1,cube2,pt1,...)",
...
#ifdef TEST // [[2do]]
	{ 5, 5, "OVERLAPCUBETRI", F_OverlapCubeTri, 1, "int",
		"OverlapCubeTri(cube_mid,cube_width,pt1,pt2,pt3)",
	...
	{ 0, MAX_FUNC_PARAM, "IF$ENGINE", F_if_engine, 0, "int", "if$engine(...)",
	...
	{ 0, MAX_FUNC_PARAM, "IF$RANDOM", F_if_random, 0, "int", "if$random(...)",
		"Create a condition for KMP/GOBJ references."
...
#if HAVE_WIIMM_EXT
	{ 2, 2, "IF$TEST", F_if_test, 0, "int", "if$test(index,bitnum)",
	...
	{ 1, 1, "CHAT$N_RACES", F_chat_n_races, 0, "int", "chat$n_races(n)",
		"Create a chat modus for LE-CODE setup."
		" N is a values between 1 and 512 and defines the number of races."
		" The parameters are used to select random scenarios between 1 and 8." },

	{ 0, MAX_FUNC_PARAM, "CHAT$VEHICLES", F_chat_vehicles, 0, "int", "chat$vehicles(...)",
...
FuncParam_t *DefineParserFunc (ccp name, // name of function
...
void DefineParserFuncTab (const FuncTable_t *ftab, // pointer to a definittion table
...
)
{
	...
	for (; ftab->func; ftab++)
	{
		if (ftab->name)
			DefineParserFunc (
				ftab->name, ftab->min_param, ftab->max_param, fform_id, ftab->func, ftab->user_id);
...
const FuncParam_t *GetParserFunc (ccp name, // name to search
...
)
{
	...
	if (si && si->no_warn <= 0)
	{
		...
		ERROR0 (ERR_WARNING, "Function '%s' not defined [%s @%u]: %.*s\n", name, sf->name, sf->line,
...
FuncInfo_t *DefineParserFuncInfo (ccp result, // function result info
...
void DumpParserFuncInfo (FILE *f, // destination file
...
)
{
	...
	if (be_verbose > 0)
	{
		...
		if (print_header)
			fprintf (f, "%*s%-*s %-*s Description\n%*s%.*s\n", indent, "", fw_result, "Type",
				fw_syntax, "Syntax", indent, "", twidth, Minus300);
		...
		for (i = 0; i < parser_func_info.used; i++)
			if (!filter || filter[i].mode)
			{
				...
				uint len = fprintf (
					f, "%*s%-*s %s", indent, "", fw_result, vp->func_info.result, vp->name);
				if (len >= fw_head)
				{
					fputc ('\n', f);
					len = 0;
	...
	else
	{
		...
		for (i = 0; i < parser_func_info.used; i++)
			if (!filter || filter[i].mode)
			{
				const Var_t *vp = parser_func_info.list + i;
				fprintf (
					f, "%*s %-*s  %s\n", indent, "", fw_result, vp->func_info.result, vp->name);
			}
	}
}
...
void ExportParserFuncMakedoc (FILE *f, ccp index)
{
	...
	for (func = parser_func.list; func < func_end; func++)
	{
		fprintf (f,
			...
			"#pdef d['p-max'] = %d\n"
			"#pdef d['info'] = @map\n",
			func->name, func->func_param.fform_id ? GetNameFF (0, func->func_param.fform_id) : "",
			func->func_param.need_name, func->func_param.min_param, func->func_param.max_param);
		...
		for (info = parser_func_info.list; info < info_end; info++)
		{
			...
			if (!strcasecmp (func->name, name))
			{
				fprintf (f,
					...
					"#pdef d['info']['%s']['info'] = \\\n",
					info->name, info->func_info.result, info->name);
...
void ExportTrackInfo (FILE *f)
{
	...
	for (i = 0; i < MKW_N_TRACKS + MKW_N_ARENAS; i++)
	{
		...
		const TrackInfo_t *ti = is_arena ? arena_info + i - MKW_N_TRACKS : track_info + i;
		...
		fprintf (f,
			...
			"	'fname'	=> \"%s\",\n"
			"	),\n\n",
			i, i, ti->def_index, ti->music_id, is_arena ? 'A' : 'T', ti->def_slot, ti->abbrev,
			ti->name_de, ti->name_en, ti->track_fname);
	}
