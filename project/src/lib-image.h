...
enumError SavePNG (Image_t *img, // pointer to valid img
...
enumError ExportPNG (ccp path1, // NULL or part #1 of path
	...
	palette_format_t ext_pform, uint ext_n_pal, const u8 *ext_pal);
...
enumError PatchListIMG (Image_t *img // image to patch
);
