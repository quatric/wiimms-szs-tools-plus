...
typedef enum file_format_t
{
	...
	FF_MSH, // 194 - Monster Games collision mesh (.msh)
	FF_MOD, // 195 - Monster Games display list model (.mod)
	FF_PERS, // 196 - Pokemon Stadium N64 Model / Fragment (.pers / FRAGMENT)
