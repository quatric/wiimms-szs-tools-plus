...
static u8 *AllocDataIMG (const Image_t *src, // image template (read width and height)
...
static void AssignData (Image_t *dest, // valid destination
	const Image_t *src, // NULL or image template
...
static enumError CalcImageBlock (const Image_t *img, // image template (read width and height)
...
static enumError conv_from_CMPR (Image_t *dest_img, // valid destination
	const Image_t *src_img, // valid source
	image_format_t iform // new image format, only valid IMG_X_*
)
{
...
static enumError conv_to_CMPR (Image_t *dest_img, // valid destination
	const Image_t *src_img, // valid source
	palette_format_t pform // wanted palette format => ignored
)
{
