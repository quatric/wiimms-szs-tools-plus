...
typedef enumError (*call_func_t) (struct Var_t *res, // store result here
	...
	const struct FuncParam_t *fpar // pointer to user parameter
);
...
typedef struct FuncParam_t
{
	...
	union
	{
		...
		struct ScanMacro_t *macro; // NULL or related macro to call
	};
...
void ResetVarMap (VarMap_t *vm // data structure to reset
);
...
enumError TformScriptCallF (uint dimension, // '2' for a 2D and '3' for a 3D vector
	float3 *v, // pointer to list of 3D vectors
	int n, // number of 3D vectors
	uint off // if n>1: offset from one to next vector
);

enumError TformScriptCallD (uint dimension, // '2' for a 2D and '3' for a 3D vector
...
void TransformPosFloat2D (float *v, // pointer to list of 2D vectors
	int n, // number of 2D vectors
	uint off // if n>1: offset from one to next vector
);

static inline void TransformPosFloat3D (float *v, // pointer to list of 3D vectors
	int n, // number of 3D vectors
	uint off // if n>1: offset from one to next vector
)
{
...
void TransformPosDouble2D (double *v, // pointer to list of 2D vectors
	int n, // number of 2D vectors
	uint off // if n>1: offset from one to next vector
);

static inline void TransformPosDouble3D (double *v, // pointer to list of 3D vectors
	int n, // number of 3D vectors
	uint off // if n>1: offset from one to next vector
)
{
...
void TransformScaleFloat1D (float *v, // pointer to list of 3D vectors
	int n, // number of 2D vectors
	uint off // if n>1: offset from one to next vector
);

void TransformScaleFloat3D (float *v, // pointer to list of 3D vectors
	int n, // number of 2D vectors
	uint off // if n>1: offset from one to next vector
);

void TransformScaleDouble3D (double *v, // pointer to list of 3D vectors
	int n, // number of 3D vectors
	uint off // if n>1: offset from one to next vector
);
...
void TransformRotFloat3D (float *v, // pointer to list of 3D vectors
	int n, // number of 2D vectors
	uint off // if n>1: offset from one to next vector
);

void TransformRotDouble3D (double *v, // pointer to list of 3D vectors
	int n, // number of 3D vectors
	uint off // if n>1: offset from one to next vector
);
...
void ResetSI (ScanInfo_t *si // data structure to setup
);
...
static inline enumError ScanUIntValueSI (ScanInfo_t *si, // valid data
...
void InitializeLine (Line_t *lin // valid line data
);
...
void CalcExpr (Var_t *dst, // first source and destination
...
{
	return cc85[rgb >> 16 & 0xff] << 11 | cc86[rgb >> 8 & 0xff] << 5 | cc85[rgb & 0xff];
}
