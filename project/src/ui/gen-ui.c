...
#define PATCH_BMG_TEXT(x)                                                                          \
	...
	" all patch files will be processed in the entered order." x                                   \
...
#define OPT_CT_DIR(x)                                                                              \
	...
	" Only files with correct file type are accepted." x "\n "                                     \
...
#define CT_CODE_SOURCE "BRRES, TEX0, CT-CODE, CT-TEXT and LE-BIN"
...
#define CONFIG_BRIEF " Suppress configuration search list."
