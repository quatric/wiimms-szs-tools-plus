...
#define IsNull3e(d, e) (fabs ((d).x) < (e) && fabs ((d).y) < (e) && fabs ((d).z) < (e))

#define IsOne3(d) ((d).x == 1.0 && (d).y == 1.0 && (d).z == 1.0)
#define IsOne3e(d, e)                                                                              \
	(fabs ((d).x - 1.0) < (e) && fabs ((d).y - 1.0) < (e) && fabs ((d).z - 1.0) < (e))

#define IsVal3(d, v) ((d).x == (v) && (d).y == (v) && (d).z == (v))
#define IsVal3e(d, v, e)                                                                           \
	(fabs ((d).x - (v)) < (e) && fabs ((d).y - (v)) < (e) && fabs ((d).z - (v)) < (e))

#define IsEQ3(a, b) ((a).x == (b).x && (a).y == (b).y && (a).z == (b).z)
#define IsEQ3e(a, b, e)                                                                            \
	(fabs ((a).x - (b).x) < (e) && fabs ((a).y - (b).y) < (e) && fabs ((a).z - (b).z) < (e))
...
#define CrossProd3x(d, a, b)                                                                       \
	do                                                                                             \
	{                                                                                              \
		typeof ((d).x) xx = (a).y * (b).z - (a).z * (b).y;                                         \
...
{
	return (int)truncf (f + 0.5);
}
static inline int double2int (double d)
{
	return (int)trunc (d + 0.5);
}
static inline s64 float2int64 (float f)
{
	return (s64)truncf (f + 0.5);
}
static inline s64 double2int64 (double d)
{
	return (s64)trunc (d + 0.5);
}
