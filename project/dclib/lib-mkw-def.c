...
MkwTrackCategory_t *GetMkwTrackCategory (int id)
{
	...
	static MkwTrackCategory_t id_MTCAT_MODEL = {
		"Model hack",
		"model,model2do,reverse,reverse2do,tiny,tiny2do,colossal,colossal2do,shrink,shrink2do,"
		"stretch,stretch2do",
		0x000000,
		0xff8000,
		0,
	...
	switch (id)
	{
		case G_MTCAT_NINTENDO:
			return &id_MTCAT_NINTENDO;
		case G_MTCAT_TEXTURE:
			return &id_MTCAT_TEXTURE;
		case G_MTCAT_TEMP_ALLOW:
			return &id_MTCAT_TEMP_ALLOW;
		case G_MTCAT_TEMP_DENY:
			return &id_MTCAT_TEMP_DENY;
		case G_MTCAT_DENY:
			return &id_MTCAT_DENY;
		case G_MTCAT_CHEAT:
			return &id_MTCAT_CHEAT;
		case G_MTCAT_EDIT:
			return &id_MTCAT_EDIT;
		case G_MTCAT_MODEL:
			return &id_MTCAT_MODEL;
		case G_MTCAT_CHEAT_EDIT:
			return &id_MTCAT_CHEAT_EDIT;
		case G_MTCAT_UNKNOWN:
			return &id_MTCAT_UNKNOWN;
		case G_MTCAT_CUSTOM:
			return &id_MTCAT_CUSTOM;
		case G_MTCAT_HNS:
			return &id_MTCAT_HNS;
		case G_MTCAT_HNS_CT:
			return &id_MTCAT_HNS_CT;
		case G_MTCAT_MISSION:
			return &id_MTCAT_MISSION;
		case G_MTCAT_MISSION_CT:
			return &id_MTCAT_MISSION_CT;
		case G_MTCAT__N:
			return &id_MTCAT__N;
		default:
			return 0;
...
const sizeof_info_t sizeof_info_mkw_def[] = { SIZEOF_INFO_TITLE ("MKW/def structs")
		SIZEOF_INFO_ENTRY (MkwTrackCategory_t) SIZEOF_INFO_TERM () };
